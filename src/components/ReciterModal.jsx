  ...
  const renderReciter=(r)=>{
    ...
    return (
      <div key={r.id} className="sbtn" onClick={()=>{
        ...
        <div style={{fontFamily:"'Amiri Quran','Amiri',serif",fontSize:16,lineHeight:1,direction:"rtl",color:isSelected?(dark?"rgba(230,184,74,0.85)":"rgba(140,100,20,0.90)"):(dark?"rgba(243,231,200,0.55)":"rgba(40,30,10,0.65)"),flexShrink:0}}>{r.arabic}</div>
