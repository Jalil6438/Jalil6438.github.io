...
export default function PageTranslationView({ translationSource, dark, setDrawerView, setShowPickers, mushafPage, pageVerses, translations, fontSize }) {
          const sourceLabel =
            translationSource === "sahih_intl"
              ? "Sahih International"
              : "Muhsin Khan";
          return (
            <div
