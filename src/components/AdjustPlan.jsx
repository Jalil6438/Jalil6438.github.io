...
export default function AdjustPlan({ dark, T, goalYears, setGoalYears, goalMonths, setGoalMonths, memorizedAyahs, completedCount, timeline, dailyNew, onBack, rihlahScrollRef }){
  return (
        <div ref={rihlahScrollRef} style={{flex:1,overflowY:"auto",background:dark?"linear-gradient(180deg,#0B1220,#0E1628)":"#F3E9D2",padding:"16px 16px 120px"}} className="fi gold-particles">
          <div style={{marginBottom:20}}>
            <div className="sbtn" onClick={onBack} style={{display:"inline-block",padding:"6px 12px",background:dark?"rgba(255,255,255,0.04)":"#EADFC8",border:dark?"1px solid rgba(217,177,95,0.12)":"1px solid rgba(0,0,0,0.08)",borderRadius:8,fontSize:11,color:dark?"rgba(243,231,200,0.50)":"#6B645A",marginBottom:10}}>← Back</div>
          </div>
