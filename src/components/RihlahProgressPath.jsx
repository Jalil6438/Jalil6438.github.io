...
export default function RihlahProgressPath({dark,T,completedCount,sessionJuz,timeline,pct,goalYears,goalMonths,goalLabel}){
  ...
  const startPt={x:-130,y:255};
  const pathD=`M ${startPt.x} ${startPt.y} C -60 285 370 230 ${waypoints[0].x} ${waypoints[0].y} C 370 185 -50 175 ${waypoints[1].x} ${waypoints[1].y} C -50 125 340 115 ${waypoints[2].x} ${waypoints[2].y} C 340 75 20 60 ${waypoints[3].x} ${waypoints[3].y} C 20 5 380 -15 ${waypoints[4].x} ${waypoints[4].y}`;
  ...
  return (
    <div style={{borderRadius:20,overflow:"visible",marginBottom:10,position:"relative",padding:"10px 16px 0"}}>
      ...
      <svg viewBox="-140 -85 540 360" style={{width:"80%",height:"auto",margin:"0 auto",display:"block",overflow:"visible"}}>
        <defs>
