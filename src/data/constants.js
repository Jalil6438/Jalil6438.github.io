...
// Single source of truth for the vertical line-spacing of every rendered mushaf
// ayah line. Consumed by BOTH Qur'an-page renderers — InteractiveMushafPage
// (the Qur'an tab) and MushafPage (Fajr / Review / Memorization study views) —
...
export const RECITERS = [
  ...
  { id:"juhany",  name:"Abdullah Al-Juhany",     arabic:"عبدالله الجهني",   recitationId:null, qulSlug:"juhany",   everyayah:"Abdullaah_3awwaad_Al-Juhaynee_128kbps", quranicaudio:"abdullaah_3awwaad_al-juhaynee", tag:"Masjid Al-Haram",  style:"Clear · Balanced",         dot:"#4A9EFF" },
  ...
  { id:"shuraim", name:"Saud Ash-Shuraim",       arabic:"سعود الشريم",      recitationId:10,   qulSlug:"shuraim", everyayah:"Saood_ash-Shuraym_128kbps",             quranicaudio:"sa3ood_al-shuraym",             tag:"Masjid Al-Haram",  style:"Strong · Measured",        dot:"#8B9BAA" },
  { id:"muaiqly", name:"Maher Al-Muaiqly",       arabic:"ماهر المعيقلي",    recitationId:null, qulSlug:"muaiqly",  everyayah:"MaherAlMuaiqly128kbps",                 quranicaudio:"maher_almuaiqly",               tag:"Masjid Al-Haram",  style:"Warm · Melodic",           dot:"#F6A623" },
