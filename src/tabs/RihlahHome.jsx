...
export default function RihlahHome({
  ...
  return (
    <div ref={rihlahScrollRef} style={{flex:1,overflowY:"auto",overflowX:"hidden",background:"transparent",position:"relative",zIndex:1,minHeight:0}} className="fi">
      ...
      <div style={{padding:`8px 14px ${haramainMeta?"140px":"24px"}`,position:"relative",zIndex:1}}>
      ...
      <div style={{background:dark?"linear-gradient(135deg,rgba(30,35,50,0.9) 0%,rgba(20,25,40,0.7) 100%)":"#EADFC8",backdropFilter:"blur(20px)",border:"1px solid rgba(255,255,255,0.08)",borderRadius:22,boxShadow:dark?"0 8px 32px rgba(0,0,0,0.4),inset 0 1px 0 rgba(255,255,255,0.05)":"0 4px 16px rgba(0,0,0,0.06),inset 0 1px 0 rgba(255,255,255,0.5)",padding:"12px",marginBottom:8}}>
        ...
        {allChecked?(
          <div style={{textAlign:"center",padding:"14px 0"}}>
            <div style={{marginBottom:6,color:"#F0C040",display:"flex",justifyContent:"center"}}><CrescentGlyph size={26}/></div>
      ...
      {/* Permanent badge wall removed — celebrations already pop on streak /
          juz milestones, which is where the visual reward belongs. */}
