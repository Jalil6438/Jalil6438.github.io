...
export default function RihlahHome({
  ...
  const JuzBadge=({count,juzProgress})=>{
    ...
    <div style={{display:"flex",flexDirection:"column",alignItems:"center",gap:6,borderRadius:16,padding:"8px",marginTop:4}}>
      <img src={juzImg} alt="" style={{width:80,height:80,objectFit:"contain",flexShrink:0,opacity:0.06+0.94*p,filter:`grayscale(${(1-p)*0.8}) drop-shadow(0 0 ${20*p}px rgba(52,211,153,${0.8*p})) drop-shadow(0 0 ${8*p}px rgba(52,211,153,${0.5*p}))`,transition:"all .4s ease"}}/>
  ...
  const StreakSlot=({progress,tier})=>{
    ...
    <div style={{display:"flex",flexDirection:"column",alignItems:"center",gap:6,borderRadius:16,padding:"8px"}}>
      <img src={tier.img} alt="" style={{width:80,height:80,objectFit:"contain",flexShrink:0,opacity:0.06+0.94*p,filter:`grayscale(${(1-p)*0.8}) drop-shadow(0 0 ${20*p}px rgba(249,115,22,${0.8*p})) drop-shadow(0 0 ${8*p}px rgba(249,115,22,${0.5*p}))`,transition:"all .4s ease"}}/>
  ...
  const HifzGoalBadge=({progress})=>{
    ...
    return (
    <div style={{display:"flex",flexDirection:"column",alignItems:"center",gap:6,borderRadius:16,padding:"8px",marginTop:4}}>
      <img src="/badge-hafiz.png" alt="" style={{width:80,height:80,objectFit:"contain",flexShrink:0,opacity:0.06+0.94*p,filter:`grayscale(${(1-p)*0.8}) drop-shadow(0 0 ${24*p}px rgba(212,175,55,${0.9*p})) drop-shadow(0 0 ${10*p}px rgba(212,175,55,${0.6*p}))`,transition:"all .4s ease"}}/>
  ...
  return (
    <div ref={rihlahScrollRef} style={{flex:1,overflowY:"auto",background:dark?"radial-gradient(circle at top, rgba(32,44,90,0.35) 0%, rgba(8,12,24,1) 45%, rgba(4,7,15,1) 100%)":"#F3E9D2"}} className="fi">
      ...
      <div style={{background:dark?"linear-gradient(135deg,rgba(30,35,50,0.9) 0%,rgba(20,25,40,0.7) 100%)":"#EADFC8",backdropFilter:"blur(20px)",border:"1px solid rgba(255,255,255,0.08)",borderRadius:22,boxShadow:dark?"0 8px 32px rgba(0,0,0,0.4),inset 0 1px 0 rgba(255,255,255,0.05)":"0 4px 16px rgba(0,0,0,0.06),inset 0 1px 0 rgba(255,255,255,0.5)",padding:"18px 14px",marginBottom:10,position:"relative",overflow:"hidden"}}>
        ...
        <div style={{display:"flex",alignItems:"flex-start",justifyContent:"center",gap:12,position:"relative",zIndex:1,background:"linear-gradient(180deg,rgba(255,255,255,0.04),rgba(0,0,0,0.2))",borderRadius:16,padding:"14px 6px 14px 2px",boxShadow:"inset 0 1px 0 rgba(255,255,255,0.05)",overflowX:"auto"}}>
