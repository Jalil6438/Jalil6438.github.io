        ...
        <div style={{flex:1,display:"flex",flexDirection:"column",overflow:"hidden",background:parchment}}>
          ...
          {drawerView!=="tafsir"&&(quranMode==="mushaf"?(
            ...
            <div
              ...
              style={{position:"relative",flex:1,overflowY:"hidden",background:dark?"linear-gradient(180deg,#0B1220,#0E1628)":"#F3E9D2",padding:`4px 0 36px`,display:"flex",flexDirection:"column",justifyContent:mushafPage<=2?"center":"flex-start"}}
            >
