                    ...
                    return (<div style={mushafPage<=2?{padding:"8px 2px 0",position:"relative",flex:1,display:"flex",flexDirection:"column",minHeight:0}:{padding:"8px 2px 0",position:"relative"}}>
                      {(()=>{
                        ...
                        const entries=pageLayout.map((layoutEntry,i)=>{
                          ...
                          return (
                          <div key={i} style={{direction:"rtl",display:"flex",justifyContent:isCenter?"center":"space-between",alignItems:"center",maxWidth:fontEd==="v4"?"min(540px,96vw)":"min(540px,94vw)",marginInline:"auto",fontFamily:`'p${mushafPage}-${fontEd}',serif`,fontSize:fontEd==="v4"?"clamp(17px,4.3vw,26px)":"clamp(20px,5.5vw,31px)",color:dark?"#E8DFC0":"#2D2A26",padding:"2px 0",whiteSpace:"nowrap",gap:isCenter?"0.25em":"0.10em",fontPalette:dark&&fontEd==="v4"?`--dark-p${mushafPage}-v4`:undefined}}>
                            {tokens.map((w,wi)=>{
