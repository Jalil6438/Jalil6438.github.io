              ...
              <div onClick={e=>e.stopPropagation()} style={{position:"fixed",bottom:0,left:0,right:0,zIndex:999,maxHeight:"80vh",background:dark?"linear-gradient(180deg,#0E1628 0%,#080E1A 100%)":"#EADFC8",borderRadius:"18px 18px 0 0",borderTop:dark?"1px solid rgba(217,177,95,0.18)":"1px solid rgba(139,106,16,0.18)",boxShadow:"0 -8px 40px rgba(0,0,0,0.40)",padding:"14px 18px 32px",overflowY:"auto",animation:"slideUpDrawer .22s ease-out"}}>
                ...
                */}
                ...
                <div style={{padding:"12px 6px"}}>
                  <div style={{fontSize:13,fontWeight:600,color:dark?"rgba(243,231,200,0.90)":"#2D2A26",marginBottom:10}}>Tafsir</div>
                  <div style={{display:"flex",gap:6}}>
          ...
          {drawerView!=="tafsir"&&drawerView!=="translation"&&drawerView!=="tafsir-page"&&(
            ...
            >
              ...
              {mushafLoading?(
                ...
                <div style={(mushafPage<=2||mushafPage===57)?{padding:0,flex:1,display:"flex",flexDirection:"column",minHeight:0}:{padding:0}}>
                  {(()=>{
                    ...
                    return (<div style={mushafPage<=2?{padding:"8px 0 0",position:"relative",flex:1,display:"flex",flexDirection:"column",minHeight:0}:(mushafPage===57?{padding:"8px 0 0",position:"relative",flex:1,display:"flex",flexDirection:"column",justifyContent:"space-between",minHeight:0}:{padding:"8px 0 0",position:"relative"})}>
                      {(()=>{
