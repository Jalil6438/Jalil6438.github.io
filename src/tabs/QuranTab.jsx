        ...
        <div style={{flex:1,display:"flex",flexDirection:"column",overflow:"hidden",background:parchment,paddingBottom:100}}>
          ...
          {quranMode==="mushaf"?(
            ...
            <div
              ...
              style={{position:"relative",flex:1,overflowY:"auto",background:dark?"#060C18":"#F3E9D2",padding:`10px 12px ${haramainMeta?"200px":"140px"}`,display:"flex",flexDirection:"column",justifyContent:"center"}}
            >
