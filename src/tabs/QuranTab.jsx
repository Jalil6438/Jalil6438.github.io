        ...
        <div style={{flex:1,display:"flex",flexDirection:"column",overflow:"hidden",background:parchment,paddingBottom:100}}>
          ...
          {drawerView!=="tafsir"&&(quranMode==="mushaf"?(
            ...
            <div
              ...
              style={{position:"relative",flex:1,overflowY:"hidden",background:dark?"linear-gradient(180deg,#0B1220,#0E1628)":"#F3E9D2",padding:`4px 0 8px`,display:"flex",flexDirection:"column",justifyContent:"flex-start"}}
            >
              ...
              {mushafLoading?(
                ...
                <div style={{padding:0,flex:1,display:"flex",flexDirection:"column",minHeight:0}}>
                  {(()=>{
                    ...
                    return (<div style={{padding:"2px 2px 0",position:"relative",flex:1,display:"flex",flexDirection:"column",minHeight:0}}>
                      {(()=>{
                        ...
                        return pageLayout.map((layoutEntry,i)=>{
                            ...
                            return (
                              <div key={i} style={{textAlign:"center",padding:"2px 0",flexShrink:0}}>
                                <div style={{position:"relative",width:"100%",height:46,backgroundImage:"url('/surah_ornament.png')",backgroundSize:"contain",backgroundRepeat:"no-repeat",backgroundPosition:"center",display:"flex",alignItems:"center",justifyContent:"center"}}>
                                  <span style={{fontFamily:"'surah-names',serif",fontSize:"clamp(20px,5.5vw,32px)",color:dark?"rgba(232,200,120,0.85)":"rgba(0,0,0,0.70)",lineHeight:1,display:"inline-flex",alignItems:"center",gap:"0.04em",direction:"rtl"}}>
                                    <span>surah</span>
                          ...
                          return (
                          <div key={i} className={vkForLine?"sbtn":undefined} onClick={vkForLine?()=>{setSelectedAyah(vkForLine);setDrawerView("default");setShowPickers(true);setTimeout(()=>{try{window.scrollTo({top:0,behavior:"smooth"});document.querySelectorAll('[class*="fi"]').forEach(el=>{if(el.scrollTop>0)el.scrollTo({top:0,behavior:"smooth"});});}catch{}},10);}:undefined} style={{direction:"rtl",display:"flex",justifyContent:isCenter?"center":"space-between",alignItems:"center",width:"100%",marginInline:"auto",fontFamily:`'p${mushafPage}',serif`,fontSize:"clamp(16px,4.2vw,26px)",color:dark?"#E8DFC0":"#2D2A26",padding:"1px 2px",whiteSpace:"nowrap",gap:isCenter?"0.25em":0,cursor:vkForLine?"pointer":"default",flex:1,minHeight:0,boxSizing:"border-box"}}>
