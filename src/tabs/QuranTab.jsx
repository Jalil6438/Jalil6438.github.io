              ...
              {mushafLoading?(
                ...
                <div style={{padding:0,flex:1,display:"flex",flexDirection:"column",minHeight:0}}>
                  {(()=>{
                    ...
                    return (<div style={{padding:"8px 0 0",position:"relative",flex:1,display:"flex",flexDirection:"column",justifyContent:mushafPage<=2?"center":"space-between",minHeight:0}}>
                      {(()=>{
