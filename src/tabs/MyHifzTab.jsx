                              ...
                              {group.verses.map((v)=>{
                                ...
                                return (
                                  <span key={vKey}>
                                    ...
                                    <span style={{fontFamily:"'Amiri Quran','Amiri',serif",fontSize:16,color:dark?"rgba(212,175,55,0.40)":"#A08848",padding:"0 6px 0 2px",display:"inline-block"}}>﴿{toArabicDigits(aNum)}﴾</span>
                                  </span>
                                );
                              })}
                            </div>
                                ...
                                {sub.ayahs.map(v=>{
                                  ...
                                  return (
                                    <span key={vKey} className="sbtn" onClick={()=>{setOpenAyah(vKey);fetchTranslations([v]);}}
                                      ...
                                      <span style={{fontFamily:"'Amiri Quran','Amiri',serif",fontSize:16,color:dark?"rgba(212,175,55,0.38)":"#A08848",padding:"0 6px 0 2px",display:"inline-block"}}>﴿{toArabicDigits(aNum)}﴾</span>
                                    </span>
                                  );
                                })}
                              </div>
