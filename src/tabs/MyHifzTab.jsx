                    ...
                    <div style={{padding:"0 2px"}}>
                      ...
                      {(()=>{
                        ...
                        return pageLayout.map((layoutEntry,i)=>{
                          ...
                          return (
                            <div key={i} style={{direction:"rtl",display:"flex",justifyContent:isCenter?"center":"space-between",alignItems:"center",maxWidth:"min(540px,90vw)",marginInline:"auto",fontFamily:`'p${fajrPageNum}',serif`,fontSize:"clamp(20px,5vw,29px)",color:dark?"#E8DFC0":"#2D2A26",padding:"4px 0",whiteSpace:"nowrap",gap:isCenter?"0.25em":"0.10em"}}>
