                    ...
                    <div style={{padding:"0 2px"}}>
                      ...
                      {(()=>{
                        ...
                        return pageLayout.map((layoutEntry,i)=>{
                          ...
                          return (
                            <div key={i} style={{direction:"rtl",display:"flex",justifyContent:isCenter?"center":"space-between",alignItems:"center",maxWidth:"min(540px,94vw)",marginInline:"auto",fontFamily:`'p${fajrPageNum}-v2',serif`,fontSize:"clamp(20px,5.5vw,31px)",color:dark?"#E8DFC0":"#2D2A26",padding:"2px 0",whiteSpace:"nowrap",gap:isCenter?"0.25em":"0.10em"}}>
                      ...
                      <div style={{position:"relative",padding:"32px 2px 70px"}}>
                        ...
                        {(()=>{
                          ...
                          return pageLayout.map((layoutEntry,i)=>{
                            ...
                            return (
                              <div key={i} style={{direction:"rtl",display:"flex",justifyContent:isCenter?"center":"space-between",alignItems:"center",maxWidth:"min(540px,94vw)",marginInline:"auto",fontFamily:`'p${pageNum}-v2',serif`,fontSize:"clamp(20px,5.5vw,31px)",color:dark?"#E8DFC0":"#2D2A26",padding:"2px 0",whiteSpace:"nowrap",gap:isCenter?"0.25em":"0.10em"}}>
                                {lineText.split(" ").map((w,wi)=>(<span key={wi}>{w}</span>))}
                              </div>
                            );
                          });
